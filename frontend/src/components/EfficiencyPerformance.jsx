...
const EfficiencyPerformance = () => {
  return (
    <div className="efficiency-performance">
      <div className="efficiency-heading-container">
        <h1 className="efficiency-heading">Increasing Efficiency</h1>
        <p className="efficiency-description">
          Discover how our platform enhances the efficiency of renewable data centers by optimizing performance, cooling, and power usage. Our advanced analytics and real-time monitoring help achieve remarkable sustainability and operational efficiency.
        </p>
      </div>
